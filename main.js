...
All this code is copyright Orteil, 2013-2020.
	...
	-want to mod the game? scroll down to the" section
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.foolObjects={
			...
			'Baker':{name:'Oven',desc:'A crucial element of baking cookies.',icon:1},
			...
			'Tower':{name:'Meme',desc:'Cookie memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.',icon:6},
			'Spaceship':{name:'Supermarket',desc:'A gigantic cookie emporium - your very own retail chain.',icon:7},
			'Laboratory':{name:'Stock share',desc:'You\'re officially on the stock market, and everyone wants a piece!',icon:8},
